...
#Region "Dialog Methods"
    ...
    Public Sub New()
        ...
        ChildType = Enums.SettingsPanelType.MovieTheme
        IsEnabled = True
        Image = Nothing
        ImageIndex = 11
        Order = 700
...
#Region "Interface Methodes"
    ...
    Public Sub SaveSettings() Implements Interfaces.ISettingsPanel.SaveSettings
        With Master.eSettings
            .MovieThemeDefaultSearch = txtDefaultSearchParameter.Text.Trim
...
#Region "Methods"
    ...
    Public Sub Settings_Load()
        With Master.eSettings
            ...
            txtDefaultSearchParameter.Text = .MovieThemeDefaultSearch
        End With
        'With Master.eSettings.Movie.ThemeSettings
