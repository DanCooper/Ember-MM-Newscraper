...
Partial Class frmMovie_Image
    ...
    Private Sub InitializeComponent()
        ...
        Me.tblSettings.Controls.Add(Me.gbMovieImagesLanguageOpts, 1, 0)
        Me.tblSettings.Controls.Add(Me.gbMovieImagesImageTypesOpts, 0, 1)
        ...
        Me.tblSettings.SetColumnSpan(Me.gbMovieImagesImageTypesOpts, 2)
    ...
    Friend WithEvents gbMovieImagesOpts As GroupBox
    Friend WithEvents tblMovieImagesOpts As TableLayoutPanel
    Friend WithEvents chkMovieImagesNotSaveURLToNfo As CheckBox
    Friend WithEvents chkMovieImagesDisplayImageSelect As CheckBox
    Friend WithEvents chkMovieImagesCacheEnabled As CheckBox
    Friend WithEvents gbMovieImagesLanguageOpts As GroupBox
    Friend WithEvents tblMovieImagesLanguageOpts As TableLayoutPanel
    Friend WithEvents chkMovieImagesGetBlankImages As CheckBox
    Friend WithEvents chkMovieImagesGetEnglishImages As CheckBox
    Friend WithEvents chkMovieImagesMediaLanguageOnly As CheckBox
    ...
    Friend WithEvents chkMovieExtrathumbsVideoExtraction As CheckBox
    Friend WithEvents chkMovieExtrathumbsVideoExtractionPref As CheckBox
    Friend WithEvents chkMovieActorThumbsKeepExisting As CheckBox
    Friend WithEvents txtMovieExtrathumbsHeight As TextBox
    Friend WithEvents txtMovieExtrafanartsHeight As TextBox
    Friend WithEvents chkMovieExtrafanartsPreselect As CheckBox
    Friend WithEvents txtMovieExtrathumbsWidth As TextBox
    Friend WithEvents chkMovieExtrathumbsKeepExisting As CheckBox
    Friend WithEvents cbMovieExtrafanartsPrefSize As ComboBox
    Friend WithEvents chkMovieExtrathumbsPreselect As CheckBox
    Friend WithEvents txtMovieExtrafanartsWidth As TextBox
    Friend WithEvents txtMovieExtrathumbsLimit As TextBox
    Friend WithEvents chkMovieLandscapeKeepExisting As CheckBox
    Friend WithEvents txtMovieKeyArtWidth As TextBox
    Friend WithEvents chkMovieExtrathumbsResize As CheckBox
    Friend WithEvents chkMovieExtrafanartsResize As CheckBox
    Friend WithEvents chkMovieClearLogoKeepExisting As CheckBox
    Friend WithEvents txtMovieKeyArtHeight As TextBox
    Friend WithEvents chkMovieExtrathumbsPrefSizeOnly As CheckBox
    Friend WithEvents chkMovieExtrafanartsKeepExisting As CheckBox
    Friend WithEvents chkMovieDiscArtKeepExisting As CheckBox
    Friend WithEvents txtMovieExtrafanartsLimit As TextBox
    Friend WithEvents lblMovieImagesHeaderLimit As Label
    Friend WithEvents cbMovieKeyArtPrefSize As ComboBox
    Friend WithEvents cbMovieExtrathumbsPrefSize As ComboBox
    Friend WithEvents chkMovieExtrafanartsPrefSizeOnly As CheckBox
    Friend WithEvents chkMovieKeyArtResize As CheckBox
    Friend WithEvents chkMovieKeyArtKeepExisting As CheckBox
    Friend WithEvents chkMovieClearArtKeepExisting As CheckBox
    Friend WithEvents txtMovieFanartWidth As TextBox
    Friend WithEvents chkMovieKeyArtPrefSizeOnly As CheckBox
    Friend WithEvents txtMovieBannerWidth As TextBox
    Friend WithEvents lblMovieImagesHeaderPrefSize As Label
    Friend WithEvents txtMovieFanartHeight As TextBox
    Friend WithEvents lblMovieImagesHeaderBanner As Label
    Friend WithEvents chkMovieFanartKeepExisting As CheckBox
    Friend WithEvents chkMovieFanartResize As CheckBox
    Friend WithEvents cbMovieFanartPrefSize As ComboBox
    Friend WithEvents txtMovieBannerHeight As TextBox
    Friend WithEvents lblMovieImagesHeaderMaxHeight As Label
    Friend WithEvents chkMovieFanartPrefSizeOnly As CheckBox
    Friend WithEvents lblMovieImagesHeaderClearArt As Label
    Friend WithEvents chkMovieBannerResize As CheckBox
    Friend WithEvents chkMovieBannerKeepExisting As CheckBox
    Friend WithEvents cbMovieBannerPrefSize As ComboBox
    Friend WithEvents lblMovieImagesHeaderMaxWidth As Label
    Friend WithEvents chkMovieBannerPrefSizeOnly As CheckBox
    ...
    Friend WithEvents cbMoviePosterPrefSize As ComboBox
    Friend WithEvents chkMoviePosterPrefSizeOnly As CheckBox
    Friend WithEvents chkMoviePosterKeepExisting As CheckBox
    Friend WithEvents chkMoviePosterResize As CheckBox
    Friend WithEvents txtMoviePosterWidth As TextBox
    Friend WithEvents txtMoviePosterHeight As TextBox
