...
#Region "Interface Methodes"
    ...
    Public Function InjectSettingsPanel() As Containers.SettingsPanel Implements Interfaces.IMasterSettingsPanel.InjectSettingsPanel
        ...
        Return New Containers.SettingsPanel With {
            .Contains = Enums.SettingsPanelType.TVFileNaming,
            .ImageIndex = 4,
            .Order = 300,
            .Panel = pnlSettings,
            .SettingsPanelID = "TV_FileNaming",
...
#Region "Methods"
    ...
    Private Sub pbTVSourcesADInfo_MouseEnter(sender As Object, e As EventArgs)
        Cursor = Cursors.Hand
    End Sub

    Private Sub pbTVSourcesADInfo_MouseLeave(sender As Object, e As EventArgs)
    ...
    Private Sub pbTVSourcesTvTunesInfo_MouseEnter(sender As Object, e As EventArgs)
        Cursor = Cursors.Hand
    End Sub

    Private Sub pbTVSourcesTvTunesInfo_MouseLeave(sender As Object, e As EventArgs)
        Cursor = Cursors.Default
    End Sub
