...
#Region "Methods"
    ...
    Private Sub ListView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles lvStreams.DoubleClick
    ...
    Private Sub ListView_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles lvStreams.KeyDown
    ...
    Private Sub ListView_Load()
        ...
        If tmpFileInfo.StreamDetails.Video.Count > 0 Then
            ...
            For c = 0 To tmpFileInfo.StreamDetails.Video.Count - 1
                v = tmpFileInfo.StreamDetails.Video(c)
            ...
            Next
        End If
        If tmpFileInfo.StreamDetails.Audio.Count > 0 Then
            g = New ListViewGroup With {
            ...
            For c = 0 To tmpFileInfo.StreamDetails.Audio.Count - 1
                a = tmpFileInfo.StreamDetails.Audio(c)
            ...
            Next
        End If
        If tmpFileInfo.StreamDetails.Subtitle.Count > 0 Then
            g = New ListViewGroup With {
            ...
            For c = 0 To tmpFileInfo.StreamDetails.Subtitle.Count - 1
                s = tmpFileInfo.StreamDetails.Subtitle(c)
    ...
    Private Sub ListView_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lvStreams.SelectedIndexChanged
        If lvStreams.SelectedItems.Count > 0 Then
    ...
    Private Sub Stream_Remove()
        If lvStreams.SelectedItems.Count > 0 Then
            ...
            If i.Tag.ToString = Master.eLang.GetString(595, "Video Streams") Then
                tmpFileInfo.StreamDetails.Video.RemoveAt(Convert.ToInt16(i.Text))
            End If
            If i.Tag.ToString = Master.eLang.GetString(596, "Audio Streams") Then
                tmpFileInfo.StreamDetails.Audio.RemoveAt(Convert.ToInt16(i.Text))
            End If
            If i.Tag.ToString = Master.eLang.GetString(597, "Subtitle Streams") Then
                tmpFileInfo.StreamDetails.Subtitle.RemoveAt(Convert.ToInt16(i.Text))
            End If
            ListView_Load()
        End If
    End Sub

    Private Sub Stream_Remove_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnStreamRemove.Click
        Stream_Remove()
    End Sub
        ...
        If lvStreams.SelectedItems.Count > 0 Then
            ...
            Using dEditStream As New dlgFIStreamEditor
                ...
                If Not stream Is Nothing Then
                    If i.Tag.ToString = Master.eLang.GetString(595, "Video Streams") Then
                        tmpFileInfo.StreamDetails.Video(Convert.ToInt16(i.Text)) = DirectCast(stream, MediaContainers.Video)
                    End If
                    If i.Tag.ToString = Master.eLang.GetString(596, "Audio Streams") Then
                        tmpFileInfo.StreamDetails.Audio(Convert.ToInt16(i.Text)) = DirectCast(stream, MediaContainers.Audio)
                    End If
                    If i.Tag.ToString = Master.eLang.GetString(597, "Subtitle Streams") Then
                        tmpFileInfo.StreamDetails.Subtitle(Convert.ToInt16(i.Text)) = DirectCast(stream, MediaContainers.Subtitle)
                    End If
                    ListView_Load()
                End If
            End Using
    ...
    Private Sub Stream_Edit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnStreamEdit.Click
        Stream_Edit()
    End Sub

    Private Sub Stream_New__Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnStreamNew.Click
            ...
            Using dEditStream As New dlgFIStreamEditor
                ...
                If Not stream Is Nothing Then
                    If cbStreamType.SelectedItem.ToString = Master.eLang.GetString(595, "Video Streams") Then
                        tmpFileInfo.StreamDetails.Video.Add(DirectCast(stream, MediaContainers.Video))
                    End If
                    If cbStreamType.SelectedItem.ToString = Master.eLang.GetString(596, "Audio Streams") Then
                        tmpFileInfo.StreamDetails.Audio.Add(DirectCast(stream, MediaContainers.Audio))
                    End If
                    If cbStreamType.SelectedItem.ToString = Master.eLang.GetString(597, "Subtitle Streams") Then
                        tmpFileInfo.StreamDetails.Subtitle.Add(DirectCast(stream, MediaContainers.Subtitle))
                    End If
                    ListView_Load()
                End If
            End Using
    ...
    Private Sub Stream_Type_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbStreamType.SelectedIndexChanged
