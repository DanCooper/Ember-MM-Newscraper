...
#Region "Methods"
    ...
    Private Sub CheckConditions()
        ...
        Else
            For Each tSource In Master.DB.Load_AllSources_TVShow.Where(Function(f) Not f.ID = _id)
    ...
    Private Sub dlgSourceTVShow_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not _id = -1 Then
            Dim s As Database.DBSource = Master.DB.Load_AllSources_TVShow.FirstOrDefault(Function(y) y.ID = _id)
