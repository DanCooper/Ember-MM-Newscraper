                        ...
                        While SQLreader.Read()
                            ...
                            If Not String.IsNullOrEmpty(tmpMovie.Movie.Title) Then
                                ...
                                If tmpMovie.Movie.Sets.Count > 0 Then
                                    lMoviesinSets.Add(String.Concat(StringUtils.SortTokens_Movie(tmpMovie.Movie.Title), If(Not String.IsNullOrEmpty(tmpMovie.Movie.Year), String.Format(" ({0})", tmpMovie.Movie.Year), String.Empty)))
                                End If

                                lMovies.Add(New Movies With {.DBMovie = tmpMovie, .ListTitle = String.Concat(StringUtils.SortTokens_Movie(tmpMovie.Movie.Title), If(Not String.IsNullOrEmpty(tmpMovie.Movie.Year), String.Format(" ({0})", tmpMovie.Movie.Year), String.Empty))})
    ...
    Private Sub btnSetPosterScrape_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSetPosterScrape.Click
        ...
        Try
            If currSet.Movies.Count > 0 Then
                ...
                If Not ModulesManager.Instance.ScrapeImages_Movie(collectionMovie, Enums.ScraperCapabilities_Movie_MovieSet.Poster, aList, True) Then
    ...
    Private Sub btnSetFanartScrape_Click(sender As Object, e As EventArgs) Handles btnSetFanartScrape.Click
        ...
        Try
            If currSet.Movies.Count > 0 Then
                Dim collectionMovie As New Structures.DBMovie
                collectionMovie = currSet.Movies.Item(0).DBMovie
                If Not ModulesManager.Instance.ScrapeImages_Movie(collectionMovie, Enums.ScraperCapabilities_Movie_MovieSet.Fanart, aList, True) Then
                    If aList.Count > 0 Then
                        dlgImgS = New dlgImgSelect()
