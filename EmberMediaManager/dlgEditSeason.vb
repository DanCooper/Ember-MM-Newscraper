    ...
    Private Sub SetInfo()
        Try
            With Me
                ...
                If Not IsNothing(.Banner.Image) Then
                    Dim fPath As String = .Fanart.SaveAsTVSeasonBanner(Master.currShow)
