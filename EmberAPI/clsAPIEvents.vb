...
#Region "Events"
    ...
    Public Event ProgressUpdate(ByVal mType As Enums.ModuleEventType, ByRef _params As List(Of Object))

#End Region 'Events

#Region "Methods"

    Public Sub SendEvent(ByVal mType As Enums.ModuleEventType, ByRef _params As List(Of Object))
