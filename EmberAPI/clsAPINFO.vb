...
#Region "Methods"
    ...
    ''' </remarks>
    Public Shared Function MergeDataScraperResults(ByVal DBMovie As Structures.DBMovie, ByVal ScrapedList As List(Of MediaContainers.Movie), ByVal ScrapeType As Enums.ScrapeType_Movie_MovieSet_TV, ByVal ScrapeOptions As Structures.ScrapeOptions_Movie) As Structures.DBMovie
    ...
    ''' 2014/09/01 Cocotus - First implementation: Moved all global lock settings in various data scrapers to this function, only apply them once and not in every data scraper module! Should be more maintainable!
    ''' </remarks>
    Public Shared Function MergeDataScraperResults(ByVal DBTV As Structures.DBTV, ByVal ScrapedList As List(Of MediaContainers.TVShow), ByVal ScrapeType As Enums.ScrapeType_Movie_MovieSet_TV, ByVal ScrapeOptions As Structures.ScrapeOptions_TV, ByVal withEpisodes As Boolean) As Structures.DBTV
    ...
    Public Shared Function GetNfoPath_Movie(ByVal sPath As String, ByVal isSingle As Boolean) As String
        ...
        For Each a In FileUtils.GetFilenameList.Movie(sPath, isSingle, Enums.ModType_Movie.MainNFO)
    ...
    Public Shared Function GetNfoPath_MovieSet(ByVal sPath As String) As String
        ...
        For Each a In FileUtils.GetFilenameList.MovieSet(sPath, Enums.ModType_Movie.MainNFO)
            If File.Exists(a) Then
                Return a
            End If
        Next
    ...
    Public Shared Sub SaveMovieToNFO(ByRef movieToSave As Structures.DBMovie)
        ...
        Try
            ...
            If Not String.IsNullOrEmpty(movieToSave.Filename) Then
                ...
                For Each a In FileUtils.GetFilenameList.Movie(movieToSave.Filename, movieToSave.IsSingle, Enums.ModType_Movie.MainNFO)
                    If Not Master.eSettings.GeneralOverwriteNfo Then
    ...
    Public Shared Sub SaveMovieSetToNFO(ByRef moviesetToSave As Structures.DBMovieSet)
        ...
        Try
            ...
            If Not String.IsNullOrEmpty(moviesetToSave.MovieSet.Title) Then
                ...
                For Each a In FileUtils.GetFilenameList.MovieSet(moviesetToSave.MovieSet.Title, Enums.ModType_Movie.MainNFO)
                    'If Not Master.eSettings.GeneralOverwriteNfo Then
                    '    RenameNonConfNfo(a, False)
                    'End If
