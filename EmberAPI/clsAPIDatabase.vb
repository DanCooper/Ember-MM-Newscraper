...
#Region "Methods"
    ...
    Public Function LoadTVSeasonFromDB(ByVal ShowID As Long, ByVal iSeason As Integer, ByVal WithShow As Boolean) As Structures.DBTV
        ...
        Using SQLcommandTVSeason As SQLite.SQLiteCommand = _myvideosDBConn.CreateCommand()
            SQLcommandTVSeason.CommandText = String.Concat("SELECT idSeason, Lock , Mark FROM seasons WHERE idShow = ", ShowID, " AND Season = ", iSeason, ";")
            Using SQLReader As SQLite.SQLiteDataReader = SQLcommandTVSeason.ExecuteReader
                If SQLReader.HasRows Then
                    SQLReader.Read()
                    _TVDB.SeasonID = Convert.ToInt64(SQLReader("idSeason"))
        ...
        Using SQLcommand As SQLite.SQLiteCommand = _myvideosDBConn.CreateCommand()
            ...
            If Not _movieDB.ID = -1 Then
                ...
                Using SQLcommand_art As SQLite.SQLiteCommand = _myvideosDBConn.CreateCommand()
                    SQLcommand_art.CommandText = String.Concat("DELETE FROM art WHERE media_id = ", _movieDB.ID, ";")
    ...
    Public Function SaveMovieSetToDB(ByVal _moviesetDB As Structures.DBMovieSet, ByVal IsNew As Boolean, Optional ByVal BatchMode As Boolean = False, Optional ByVal ToNfo As Boolean = False, Optional ByVal withMovies As Boolean = False) As Structures.DBMovieSet
        ...
        Try
            ...
            'Images
            Using SQLcommand_art As SQLite.SQLiteCommand = _myvideosDBConn.CreateCommand()
                SQLcommand_art.CommandText = String.Concat("DELETE FROM art WHERE media_id = ", _moviesetDB.ID, ";")
                SQLcommand_art.ExecuteNonQuery()
            End Using
    ...
    Public Sub SaveTVEpToDB(ByVal _TVEpDB As Structures.DBTV, ByVal IsNew As Boolean, ByVal WithSeason As Boolean, Optional ByVal BatchMode As Boolean = False, Optional ByVal ToNfo As Boolean = False)
        ...
        Using SQLcommand As SQLite.SQLiteCommand = _myvideosDBConn.CreateCommand()
            ...
            If Not _TVEpDB.EpID = -1 Then
                ...
                'Images
                Using SQLcommand_art As SQLite.SQLiteCommand = _myvideosDBConn.CreateCommand()
                    SQLcommand_art.CommandText = String.Concat("DELETE FROM art WHERE media_id = ", _TVEpDB.EpID, ";")
                    SQLcommand_art.ExecuteNonQuery()
                End Using
    ...
    Public Sub SaveTVSeasonToDB(ByRef _TVSeasonDB As Structures.DBTV, ByVal IsNew As Boolean, Optional ByVal BatchMode As Boolean = False)
        ...
        Using SQLcommandTVSeason As SQLite.SQLiteCommand = _myvideosDBConn.CreateCommand()
            SQLcommandTVSeason.CommandText = String.Concat("INSERT OR ", If(IsNew, "IGNORE", "REPLACE"), " INTO seasons (", _
              "idShow, Season, SeasonText, Lock, Mark, New", _
              ") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?);")
            ...
            'Images
            Using SQLcommand_art As SQLite.SQLiteCommand = _myvideosDBConn.CreateCommand()
                SQLcommand_art.CommandText = String.Concat("DELETE FROM art WHERE media_id = ", _TVSeasonDB.SeasonID, ";")
                SQLcommand_art.ExecuteNonQuery()
            End Using
        ...
        Try
            ...
            Using SQLcommand As SQLite.SQLiteCommand = _myvideosDBConn.CreateCommand()
                ...
                If Not _TVShowDB.ShowID = -1 Then
                    ...
                    'Images
                    Using SQLcommand_art As SQLite.SQLiteCommand = _myvideosDBConn.CreateCommand()
                        SQLcommand_art.CommandText = String.Concat("DELETE FROM art WHERE media_id = ", _TVShowDB.ShowID, ";")
                        SQLcommand_art.ExecuteNonQuery()
                    End Using
