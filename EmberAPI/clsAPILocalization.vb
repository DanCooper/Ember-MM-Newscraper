...
#Region "Methods"
    ...
    ''' <returns></returns>
    Shared Function ISOCheckLangByCode2(ByVal code As String) As String
    ...
    Public Function GetString(ByVal ID As Integer, ByVal strDefault As String) As String
        ...
        _htStrings = _htArrayStrings.FirstOrDefault(Function(x) x.AssenblyName = Assembly).htStrings
        If _htStrings Is Nothing Then
            tStr = strDefault
        Else
            x1 = From x As LanguageString In _htStrings.string Where (x.id = ID)
            If x1.Count = 0 Then
