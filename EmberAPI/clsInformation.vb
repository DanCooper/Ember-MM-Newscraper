...
#Region "Methods"
    ...
    Public Shared Function MergeResults(ByVal dbElement As Database.DBElement, ByVal scrapedList As List(Of MediaContainers.MainDetails), ByVal scrapeOptions As Structures.ScrapeOptions, ByVal withEpisodes As Boolean) As Database.DBElement
        ...
        With nSettings
            ...
            For Each cScraperData In scrapedList
                ...
                'Collection
                If OverwriteValue(scrapeOptions.Collection, new_Collection, dbElement.MainDetails.SetsSpecified, cScraperData.SetsSpecified, .Collection) Then
    ...
    Public Shared Sub FilterCountLimit(ByVal iLimit As Integer, ByRef lstPerson As List(Of MediaContainers.Person))
    ...
    Public Shared Sub ReorderPersons(ByRef lstPerson As List(Of MediaContainers.Person))
