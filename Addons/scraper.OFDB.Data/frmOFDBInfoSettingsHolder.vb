...
#Region "Methods"
    ...
    Private Sub btnDown_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDown.Click
        Dim order As Integer = ModulesManager.Instance.externalMovieDataScrapersModules.FirstOrDefault(Function(p) p.AssemblyName = OFDB_Data._AssemblyName).ScraperOrder
        If order < ModulesManager.Instance.externalMovieDataScrapersModules.Count - 1 Then
            ...
            ModulesManager.Instance.externalMovieDataScrapersModules.FirstOrDefault(Function(p) p.AssemblyName = OFDB_Data._AssemblyName).ScraperOrder = order + 1
