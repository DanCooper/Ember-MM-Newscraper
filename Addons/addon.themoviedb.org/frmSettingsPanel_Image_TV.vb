...
#Region "Dialog Methods"
    ...
    Public Sub New()
        ...
        ParentType = Enums.SettingsPanelType.TVImage
...
#Region "Methods"
    ...
    Private Sub Handle_SettingsChanged(sender As Object, e As EventArgs) Handles _
        chkScrapeEpisodePoster.CheckedChanged,
        chkScrapeSeasonPoster.CheckedChanged,
        chkScrapeShowFanart.CheckedChanged,
        chkScrapeShowPoster.CheckedChanged
