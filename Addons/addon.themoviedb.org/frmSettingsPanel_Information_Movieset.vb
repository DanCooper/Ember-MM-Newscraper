...
Public Class frmSettingsPanel_Information_Movieset
...
#Region "Dialog Methods"
    ...
    Public Sub New()
        ...
        ParentType = Enums.SettingsPanelType.MoviesetInformation

        Setup()
    End Sub

    Private Sub Setup()
        chkEnabled.Text = Master.eLang.CommonWordsList.Enabled
