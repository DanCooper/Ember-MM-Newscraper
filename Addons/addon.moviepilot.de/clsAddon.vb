...
#Region "Methods"
    ...
    Public Shared Function GetMovieInfo(ByVal strOriginalTitle As String,
    ...
    ''' <remarks></remarks>
    Private Shared Function GetPlotAndOutline(ByVal HTML As String) As Results
        ...
        aResults.Outline = StringUtils.CleanPlotOutline(strOutline)
        aResults.Plot = StringUtils.CleanPlotOutline(strPlot)
    ...
    Private Shared Function SearchMovie(ByVal title As String, ByVal year As Integer) As String
