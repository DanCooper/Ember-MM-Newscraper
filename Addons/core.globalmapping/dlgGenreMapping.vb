...
#Region "Fields"
    ...
    Private tmpGenreXML As XmlGenreMapping
...
#Region "Methods"
    ...
    Sub New()
        ...
        tmpGenreXML = CType(APIXML.GenreMappings.CloneDeep, XmlGenreMapping)
        PopulateGenres()
    End Sub
    ...
    Public Sub SaveChanges()
        APIXML.GenreMappings = tmpGenreXML
        APIXML.GenreMappings.Save()
    End Sub
