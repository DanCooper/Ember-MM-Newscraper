...
#Region "Interface Methods"
    ...
    Sub InjectSettingsPanel() Implements Interfaces.IGenericModule.InjectSettingsPanel
        Settings_Load()
    ...
    Sub SaveSetupModule(ByVal DoDispose As Boolean) Implements Interfaces.IGenericModule.SaveSetup
