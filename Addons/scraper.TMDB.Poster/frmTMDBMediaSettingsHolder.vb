...
#Region "Methods"
    ...
    Private Sub btnDown_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDown.Click
        Dim order As Integer = ModulesManager.Instance.externalMoviePosterScrapersModules.FirstOrDefault(Function(p) p.AssemblyName = TMDB_Poster._AssemblyName).ScraperOrder
        If order < ModulesManager.Instance.externalMoviePosterScrapersModules.Count - 1 Then
            ...
            ModulesManager.Instance.externalMoviePosterScrapersModules.FirstOrDefault(Function(p) p.AssemblyName = TMDB_Poster._AssemblyName).ScraperOrder = order + 1
