        ...
        Select Case mType
            Case Enums.ModuleEventType.CommandLine
                ...
                Using SQLNewcommand As SQLite.SQLiteCommand = Master.DB.MyVideosDBConn.CreateCommand()
                    ...
                    Using SQLreader As SQLite.SQLiteDataReader = SQLNewcommand.ExecuteReader()
                        While SQLreader.Read()
                            MovieList.Add(Master.DB.LoadFromDB_Movie(Convert.ToInt32(SQLreader("idMovie"))))
                        End While
                    End Using
                End Using
                ...
                Using SQLNewcommand As SQLite.SQLiteCommand = Master.DB.MyVideosDBConn.CreateCommand()
                    ...
                    Using SQLreader As SQLite.SQLiteDataReader = SQLNewcommand.ExecuteReader()
                        While SQLreader.Read()
                            TVShowList.Add(Master.DB.LoadFromDB_TVSeason(Convert.ToInt32(SQLreader("idShow")), True, True, MySettings.ExportMissingEpisodes))
                        End While
                    End Using
                End Using
