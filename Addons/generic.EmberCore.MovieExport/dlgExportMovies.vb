                ...
                Using SQLreader As SQLite.SQLiteDataReader = SQLNewcommand.ExecuteReader()
                    If SQLreader.HasRows Then
                        While SQLreader.Read()
                            Dim _tmpMovie As Database.DBElement = Master.DB.LoadFromDB_Movie(Convert.ToInt32(SQLreader("idMovie")))
        ...
        If bHasChangedList_TVShows Then
            ...
            Using SQLNewcommand As SQLite.SQLiteCommand = Master.DB.MyVideosDBConn.CreateCommand()
                ...
                Using SQLreader As SQLite.SQLiteDataReader = SQLNewcommand.ExecuteReader()
                    If SQLreader.HasRows Then
                        While SQLreader.Read()
                            Dim _tmpTVShow As Database.DBElement = Master.DB.LoadFromDB_TVSeason(Convert.ToInt32(SQLreader("idShow")), True, True, bExportMissingEpisodes)
