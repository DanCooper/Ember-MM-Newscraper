...
#Region "Properties"
    ...
    Private Property IsEnabled() As Boolean Implements Interfaces.IScraperModule_Image_Movie.IsEnabled
...
#Region "Interface Methods"
    ...
    Sub Init() Implements Interfaces.IScraperModule_Image_Movie.Init
        Settings_Load()
    End Sub

    Sub InjectSettingsPanel() Implements Interfaces.IScraperModule_Image_Movie.InjectSettingsPanel
        Settings_Load()
    ...
    Function QueryScraperCapabilities(ByVal cap As Enums.ModifierType) As Boolean Implements Interfaces.IScraperModule_Image_Movie.QueryScraperCapabilities
        Select Case cap
    ...
    Function Run(ByRef DBMovie As Database.DBElement, ByRef ImagesContainer As MediaContainers.SearchResultsContainer, ByVal ScrapeModifiers As Structures.ScrapeModifiers) As Interfaces.ModuleResult Implements Interfaces.IScraperModule_Image_Movie.Run
        ...
        If DBMovie.Movie.UniqueIDs.TMDbIdSpecified Then
            ImagesContainer = imageScraper.GetImages_Movie_MovieSet(DBMovie.Movie.UniqueIDs.TMDbId, FilteredModifiers)
        ElseIf DBMovie.Movie.UniqueIDs.IMDbIdSpecified Then
            ImagesContainer = imageScraper.GetImages_Movie_MovieSet(DBMovie.Movie.UniqueIDs.IMDbId, FilteredModifiers)
        Else
            _Logger.Trace(String.Concat("[FanartTV_Image] [Scraper_Movie] [Abort] No TMDB and IMDB ID exist to search: ", DBMovie.ListTitle))
        End If
    ...
    Sub SaveSetup(ByVal DoDispose As Boolean) Implements Interfaces.IScraperModule_Image_Movie.SaveSetup
...
#Region "Properties"
    ...
    Private Property IsEnabled() As Boolean Implements Interfaces.IScraperModule_Image_Movieset.IsEnabled
...
#Region "Events"
    ...
    Public Event StateChanged(ByVal SettingsPanelID As String, ByVal State As Boolean, ByVal DiffOrder As Integer) Implements Interfaces.IScraperModule_Image_Movieset.StateChanged
...
#Region "Interface Methods"
    ...
    Function Run(ByRef DBMovieset As Database.DBElement, ByRef ImagesContainer As MediaContainers.SearchResultsContainer, ByVal ScrapeModifiers As Structures.ScrapeModifiers) As Interfaces.ModuleResult Implements Interfaces.IScraperModule_Image_Movieset.Run
        ...
        If DBMovieset.MovieSet.UniqueIDs.TMDbIdSpecified Then
            ...
            ImagesContainer = imageScraper.GetImages_Movie_MovieSet(DBMovieset.MovieSet.UniqueIDs.TMDbId, FilteredModifiers)
        End If
...
#Region "Properties"
    ...
    Private Property IsEnabled() As Boolean Implements Interfaces.IScraperModule_Image_TV.IsEnabled
            ...
            Case Enums.ContentType.TVEpisode
                If DBTV.TVShow.UniqueIDs.TVDbIdSpecified Then
                    If FilteredModifiers.MainFanart Then
                        ImagesContainer.MainFanarts = imageScraper.GetImages_TV(DBTV.TVShow.UniqueIDs.TVDbId, FilteredModifiers).MainFanarts
                    End If
                Else
                    _Logger.Trace(String.Concat("[FanartTV_Image] [Scraper_TV] [Abort] No TVDB ID exist to search: ", DBTV.ListTitle))
                End If
            Case Enums.ContentType.TVSeason
                If DBTV.TVShow.UniqueIDs.TVDbIdSpecified Then
                    ImagesContainer = imageScraper.GetImages_TV(DBTV.TVShow.UniqueIDs.TVDbId, FilteredModifiers)
                Else
                    _Logger.Trace(String.Concat("[FanartTV_Image] [Scraper_TV] [Abort] No TVDB ID exist to search: ", DBTV.ListTitle))
                End If
