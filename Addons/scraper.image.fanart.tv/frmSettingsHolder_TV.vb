...
#Region "Methods"
    ...
    Private Sub chkScrapeShowClearArt_CheckedChanged(sender As Object, e As EventArgs) Handles chkScrapeShowClearArt.CheckedChanged
        ...
        chkScrapeShowClearArtOnlyHD.Enabled = chkScrapeShowClearArt.Checked

        If Not chkScrapeShowClearArt.Checked Then
            chkScrapeShowClearArtOnlyHD.Checked = False
        End If
    End Sub
    ...
    Private Sub chkScrapeShowClearLogo_CheckedChanged(sender As Object, e As EventArgs) Handles chkScrapeShowClearLogo.CheckedChanged
        ...
        chkScrapeShowClearLogoOnlyHD.Enabled = chkScrapeShowClearLogo.Checked

        If Not chkScrapeShowClearLogo.Checked Then
            chkScrapeShowClearLogoOnlyHD.Checked = False
        End If
    End Sub
    ...
    Sub SetUp()
        ...
        chkScrapeSeasonLandscape.Text = Master.eLang.GetString(1035, "Landscape")
        chkScrapeSeasonPoster.Text = Master.eLang.GetString(148, "Poster")
        chkScrapeShowBanner.Text = Master.eLang.GetString(838, "Banner")
        chkScrapeShowClearArt.Text = Master.eLang.GetString(1096, "ClearArt")
        chkScrapeShowClearArtOnlyHD.Text = Master.eLang.GetString(1105, "Only HD")
        chkScrapeShowClearLogo.Text = Master.eLang.GetString(1097, "ClearLogo")
        chkScrapeShowClearLogoOnlyHD.Text = chkScrapeShowClearArtOnlyHD.Text
        chkScrapeShowCharacterArt.Text = Master.eLang.GetString(1140, "CharacterArt")
        chkScrapeShowFanart.Text = Master.eLang.GetString(149, "Fanart")
        chkScrapeShowLandscape.Text = Master.eLang.GetString(1035, "Landscape")
