...
#Region "Fields"
    ...
    Private _addonSettings As OMDb_Data.AddonSettings
    Private _prefLanguage As String = "en-EN"
    Private _strPosterURL As String = String.Empty
...
#Region "Methods"
    ...
    Public Sub CreateAPI(ByVal addonSettings As OMDb_Data.AddonSettings)
        Try
            ...
            logger.Trace("[OMDb_Data] [CreateAPI] Client created")
        Catch ex As Exception
            logger.Error(String.Format("[OMDb_Data] [CreateAPI] [Error] {0}", ex.Message))
            _client = Nothing
        End Try
    End Sub
    ...
    Private Sub bwTMDB_RunWorkerCompleted(ByVal sender As Object, ByVal e As System.ComponentModel.RunWorkerCompletedEventArgs) Handles bwOMDb.RunWorkerCompleted
        ...
        Select Case Res.ResultType
            ...
            Case SearchType.SearchDetails_Movie
                ...
                RaiseEvent SearchInfoDownloaded_Movie(_strPosterURL, movieInfo)

            Case SearchType.SearchDetails_TVShow
                Dim showInfo As MediaContainers.TVShow = DirectCast(Res.Result, MediaContainers.TVShow)
                RaiseEvent SearchInfoDownloaded_TVShow(_strPosterURL, showInfo)
        End Select
    End Sub
