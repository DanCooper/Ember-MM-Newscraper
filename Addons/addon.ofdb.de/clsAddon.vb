...
#Region "Methods"
    ...
    Private Shared Function CleanTitle(ByVal sString As String) As String
    ...
    ''' </remarks>
    Private Shared Function GetCertification(ByVal HTML As String) As String
    ...
    Private Shared Function GetFullPlot(ByVal sURL As String) As String
    ...
    Public Shared Function GetMovieInfo(ByVal strIMDBID As String, ByVal FilteredOptions As Structures.ScrapeOptions, ByVal strLanguage As String) As MediaContainers.MainDetails
        Try
    ...
    Private Shared Function SearchMovie(ByVal strIMDBID As String) As String
        ...
        Try
            If Not String.IsNullOrEmpty(strIMDBID) Then
                ...
                If Not String.IsNullOrEmpty(HTML) Then
                    ...
                    End If
                Else
                    _Logger.Warn("OFDB Query returned no results for ID of <{0}>", strIMDBID)
                End If
            End If
        Catch ex As Exception
            _Logger.Error(ex, New StackFrame().GetMethod().Name & Convert.ToChar(Keys.Tab) & "Error scraping ODFB (too many connections?):" & strIMDBID)
        End Try
