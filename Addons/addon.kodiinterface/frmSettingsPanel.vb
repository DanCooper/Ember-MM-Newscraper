...
#Region "Fields"
    ...
    Public HostList As New List(Of Generic.Host)
...
#Region "Methods"
    ...
    Private Sub RemoveKodiHost()
        If lbHosts.SelectedItems.Count > 0 Then
            Dim HostToRemove As Generic.Host = HostList.FirstOrDefault(Function(f) f.Label = lbHosts.SelectedItem.ToString)
    ...
    Private Sub btnAddHost_Click(sender As Object, e As EventArgs) Handles btnAddHost.Click
        Dim newHost As New Generic.Host
    ...
    Private Sub btnEditHost_Click(sender As Object, e As EventArgs) Handles btnEditHost.Click, lbHosts.DoubleClick
        If lbHosts.SelectedItems.Count > 0 Then
            Dim oldHost As Generic.Host = HostList.FirstOrDefault(Function(f) f.Label = lbHosts.SelectedItem.ToString)
