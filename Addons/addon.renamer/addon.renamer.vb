...
#Region "Events"
    ...
    Public Event GenericEvent(ByVal mType As Enums.ModuleEventType, ByRef Parameters As List(Of Object)) Implements Interfaces.IGenericModule.GenericEvent
        ...
        Select Case ModulesManager.Instance.RuntimeObjects.MediaTabSelected.ContentType
            Case Enums.ContentType.Movie
                Using dBulkRename As New dlgBulkRenamer_Movie
                    dBulkRename._FilterMovies = ModulesManager.Instance.RuntimeObjects.FilterMovies
                    dBulkRename._FilterMoviesSearch = ModulesManager.Instance.RuntimeObjects.FilterMoviesSearch
                    dBulkRename._FilterMoviesType = ModulesManager.Instance.RuntimeObjects.FilterMoviesType
                    dBulkRename._ListMovies = ModulesManager.Instance.RuntimeObjects.ListMovies
            ...
            Case Enums.ContentType.TV
                Using dBulkRename As New dlgBulkRenamer_TV
                    dBulkRename._FilterShows = ModulesManager.Instance.RuntimeObjects.FilterTVShows
                    dBulkRename._FilterShowsSearch = ModulesManager.Instance.RuntimeObjects.FilterTVShowsSearch
                    dBulkRename._FilterShowsType = ModulesManager.Instance.RuntimeObjects.FilterTVShowsType
                    dBulkRename._ListShows = ModulesManager.Instance.RuntimeObjects.ListTVShows
