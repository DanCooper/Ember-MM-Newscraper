                    ...
                    If MessageBox.Show(String.Format(If(doMove, strMove, strCopy),
                        ...
                        If ContentType = Enums.ContentType.Movie Then
                            ...
                            For Each movieID As Long In MediaToWork
                                ...
                                End If
                            Next
                            If Not _AddonSettings.TeraCopy AndAlso doMove Then ModulesManager.Instance.RuntimeObjects.InvokeLoadMedia(New Structures.ScanOrClean With {.Movies = True})
                        ElseIf ContentType = Enums.ContentType.TVShow Then
                            Dim FileDelete As New FileUtils.Delete
                            For Each tShowID As Long In MediaToWork
                                ...
                                End If
                            Next
                            If Not _AddonSettings.TeraCopy AndAlso doMove Then ModulesManager.Instance.RuntimeObjects.InvokeLoadMedia(New Structures.ScanOrClean With {.TV = True})
                        End If
