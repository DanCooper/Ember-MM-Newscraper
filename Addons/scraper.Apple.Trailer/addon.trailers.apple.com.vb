...
#Region "Interface Methods"
    ...
    Public Sub InjectSettingsPanel() Implements Interfaces.IScraperModule_Trailer_Movie.InjectSettingsPanel
        ...
        _PnlSettingsPanel.cbTrailerPrefQual.Text = _AddonSettings.TrailerPrefQual
    ...
    Public Function Run(ByRef DBMovie As Database.DBElement, ByVal Type As Enums.ModifierType, ByRef TrailerList As List(Of MediaContainers.Trailer)) As Interfaces.ModuleResult Implements Interfaces.IScraperModule_Trailer_Movie.Run
        _Logger.Trace("[Apple_Trailer] [Scraper_Movie] [Start]")
        ...
        _Logger.Trace("[Apple_Trailer] [Scraper_Movie] [Done]")
        Return New Interfaces.ModuleResult With {.breakChain = False}
    End Function

    Sub SaveSetup(ByVal DoDispose As Boolean) Implements Interfaces.IScraperModule_Trailer_Movie.SaveSetup
        _AddonSettings.TrailerPrefQual = _PnlSettingsPanel.cbTrailerPrefQual.Text
        Settings_Save()
        If DoDispose Then
...
#Region "Methods"
    ...
    Sub Settings_Load()
        _AddonSettings.TrailerPrefQual = AdvancedSettings.GetSetting("TrailerPrefQual", "1080p")
    ...
    Sub Settings_Save()
        Using settings = New AdvancedSettings()
            ...
            settings.SetSetting("TrailerPrefQual", _PnlSettingsPanel.cbTrailerPrefQual.Text)
        End Using
    End Sub
