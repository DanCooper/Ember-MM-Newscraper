...
#Region "Methods"
    ...
    Private Sub btnDown_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDown.Click
        Dim order As Integer = ModulesManager.Instance.externalTrailerScrapersModules.FirstOrDefault(Function(p) p.AssemblyName = Apple_trailer._AssemblyName).ScraperOrder
        If order < ModulesManager.Instance.externalTrailerScrapersModules.Count - 1 Then
            ...
            ModulesManager.Instance.externalTrailerScrapersModules.FirstOrDefault(Function(p) p.AssemblyName = Apple_trailer._AssemblyName).ScraperOrder = order + 1
