...
#Region "Fields"
    ...
    Private _BSEpisodes As New BindingSource
    ...
    Public _FilterShows As String = String.Empty
    Public _FilterShowsSearch As String = String.Empty
    Public _FilterShowsType As String = String.Empty
    Public _ListShows As String = String.Empty
...
#Region "Methods"
    ...
    Private Sub bwDoRename_DoWork(ByVal sender As Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles bwDoRename.DoWork
        _FFRenamer.DoRename_TVEpisodes(AddressOf ShowProgressRename)
    End Sub
    ...
    Private Sub bwLoadInfo_DoWork(ByVal sender As Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles bwLoadInfo.DoWork
        Try
            ...
            If Not String.IsNullOrEmpty(_FilterShows) Then
                If hasFilter Then
                    dbFilter = String.Concat("(", _FilterShows, ") AND ", dbFilter).Trim
                Else
                    dbFilter = String.Concat(_FilterShows).Trim
                    hasFilter = True
                End If
            End If
    ...
    Private Sub chkRenamedOnly_CheckedChanged(ByVal sender As Object, ByVal e As EventArgs) Handles chkRenamedOnly.CheckedChanged
        If chkRenamedOnly.Checked Then
            _BSEpisodes.Filter = "IsRenamed = True AND IsLocked = False"
        Else
            _BSEpisodes.RemoveFilter()
        End If
    End Sub
    ...
    Private Sub cmsEpisodeList_Opening(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles cmsEpisodeList.Opening
        Dim count As Integer = _FFRenamer.GetCountAll_TVEpisodes
        Dim lockcount As Integer = _FFRenamer.GetCountLocked_TVEpisodes
        If count > 0 Then
            If lockcount > 0 Then
    ...
    Private Sub DoProcess()
        ...
        Invoke(Sta)
        _FFRenamer.ProccessFiles_TVEpisodes(txtFolderPatternSeasons.Text, txtFilePatternEpisodes.Text)
        Invoke(Fin)
    End Sub
    ...
    Private Sub Rename_Button_Click(ByVal sender As Object, ByVal e As EventArgs) Handles Rename_Button.Click
        ...
        pbCompile.Style = ProgressBarStyle.Continuous
        pbCompile.Maximum = _FFRenamer.GetCountMax_TVEpisodes
        pbCompile.Value = 0
        Application.DoEvents()
        'Start worker
    ...
    Sub setLock(ByVal lock As Boolean)
        For Each row As DataGridViewRow In dgvEpisodesList.SelectedRows
            _FFRenamer.SetIsLocked_TVEpisodes(row.Cells(1).Value.ToString, row.Cells(2).Value.ToString, lock)
    ...
    Sub setLockAll(ByVal lock As Boolean)
        Try
            _FFRenamer.SetIsLocked_TVEpisodes(String.Empty, String.Empty, False)
    ...
    Private Sub Simulate()
        Try
            With dgvEpisodesList
                ...
                End If
                _BSEpisodes.DataSource = _FFRenamer.GetTable_TVEpisodes
                .DataSource = _BSEpisodes
