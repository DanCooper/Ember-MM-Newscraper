...
#Region "Methods"
    ...
    Private Sub CreateDummies()
        ...
        Dim dMEpisode1 As New Renamer.Episode With {.ID = 1, .Episode = 1, .Title = "Pilot"}
        Dim dMEpisode2 As New Renamer.Episode With {.ID = 2, .Episode = 2, .Title = "The Big Bran Hypothesis"}
        ...
        Dim dMSEpisode1 As New Renamer.Episode With {.ID = 1, .Episode = 1, .Title = "Pilot"}
        Dim dMSEpisode2 As New Renamer.Episode With {.ID = 2, .Episode = 2, .Title = "The Big Bran Hypothesis"}
        Dim dMSEpisode3 As New Renamer.Episode With {.ID = 3, .Episode = 1, .Title = "The Bad Fish Paradigm"}
        Dim dMSEpisode4 As New Renamer.Episode With {.ID = 4, .Episode = 2, .Title = "The Codpiece Topology"}
        ...
        Dim dSEpisode As New Renamer.Episode With {.ID = 1, .Episode = 1, .Title = "Pilot"}
