...
#Region "Fields"
    ...
    Private myWatchedEpisodes As New Dictionary(Of String, KeyValuePair(Of String, List(Of TraktAPI.Model.TraktWatchedEpisode.SeasonsWatched)))
    ...
    Private favoriteList As New TraktAPI.Model.TraktUserList
...
#Region "Methods"
    ...
    Sub SetUp()
        ...
        traktUser = clsAdvancedSettings.GetSetting("TraktUsername", "")
        traktPassword = clsAdvancedSettings.GetSetting("TraktPassword", "")
...
#Region "Trakt.tv Sync Playcount"
    ...
    Private Sub btntraktPlaycountGetMovies_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btntraktPlaycountGetMovies.Click
        Try
            ...
            Dim traktWatchedMovies As IEnumerable(Of TraktAPI.Model.TraktWatchedMovie) = TraktAPI.TrakttvAPI.GetUserWatchedMovies(traktUser)
    ...
    Private Sub btntraktPlaycountGetSeries_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btntraktPlaycountGetSeries.Click
        Try
            ...
            Trakttv.TraktSettings.Username = traktUser
            Trakttv.TraktSettings.Password = traktPassword
            Dim traktWatchedEpisodes As IEnumerable(Of TraktAPI.Model.TraktWatchedEpisode) = TraktAPI.TrakttvAPI.GetUserWatchedEpisodes(traktUser)
            ' Go through each item in collection	
